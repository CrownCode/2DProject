...
public class HipsterObject
{
	...
	public HipsterObject(String string)
	{
	...
	public HipsterObject(String name, String hipsterType, String hipsterPhrase, String[] hipsterCars, String[] hipsterBook) //2 constructors create diffrent ways to make objects.
	{
